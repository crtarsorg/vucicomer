...
?>
 ...
 <section class="container ">
    ...
    <div class="social-div">
        ...
        <a  href="https://twitter.com/intent/tweet?original_referer=www.vucicomer.rs/obecanje.php?<?php echo $_SERVER['QUERY_STRING'] . "&text=Vučićomer ".$naslov_la; ?>"> <img src="images/twitter.svg"></a>
    </div>
